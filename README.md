...
<div align="center">
    <a href="https://github.com/dedroot/gitpy">
        <img src="assets/images/gitpy_logo.png" alt="Logo" width="300" height="330"></a>
...
<h3 align="center">GitPy</h3>
    <p align="center">
        ...
        <br />
        <a href="https://github.com/dedroot/gitpy"><strong>Explore the docs »</strong></a>
        <br />
        <br />
        <a href="https://github.com/dedroot/gitpy/issues">Report Bug</a>
        ·
...
All instructions to contribute to the project are present in the [CONTRIBUTING](docs/CONTRIBUTING.md) file.
...
Thomas Pellissier - [Profile README Contacts section](https://github.com/dedroot#contacts)
...
[dedroot_twitter]: <https://twitter.com/dedr00t>
