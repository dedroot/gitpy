...
- There are a few guidelines that you must follow in order to ease the process of getting your contribution merged. See the [Coding Guidelines](CODING_GUIDELINES.md) for more information.
...
## Getting stared
  ...
  1. Open a new [Issues][issues_repo_url] and chose the **Collaborate request** template and fill it with the necessary information  \
  ...
  4. Make a Pull Request from your fork and your branch to the <ins>**`develop`**</ins> branch on the <ins>**main**</ins> repository, and after the PR's open you can start your changes. You create must open a PR before starting your changes, so we know that your working on it and we can help you if you need.
